//
//  GDNetServerDownLoadTool.m
//  QuarkData
//
//  Created by grx on 2017/7/20.
//  Copyright © 2017年 Thunder Software Technology. All rights reserved.
//

#import "GDNetServerDownLoadTool.h"
#import <AFNetworking/AFNetworking.h>
@interface GDNetServerDownLoadTool ()
@property (nonatomic,strong) NSString  *fileHistoryPath;

@end

@implementation GDNetServerDownLoadTool
static GDNetServerDownLoadTool *tool = nil;
...
-(void)cancleLocalFile:(NSString *)filepath withUrlHost:(NSString*)urlHost
{
    /** 删除未下载完成存储在Plist中的文件 */
    if ([self.downLoadHistoryDictionary valueForKey:urlHost]) {
        [self.downLoadHistoryDictionary removeObjectForKey:urlHost];
